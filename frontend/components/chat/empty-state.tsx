...
export default function EmptyState() {
  ...
  if (isLoadingThreads || isLoadingFolders) {
    return (
      <div className="flex flex-col items-center justify-center flex-1 h-full p-8 gap-8">
  ...
  return (
    <div className="flex flex-col flex-1 h-full overflow-y-auto p-8 animate-in fade-in duration-500">
                    ...
                    <CardContent>
                      <div className="flex flex-col gap-2 text-xs text-muted-foreground">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="truncate">{thread.folder_name}</span>
                        </div>
